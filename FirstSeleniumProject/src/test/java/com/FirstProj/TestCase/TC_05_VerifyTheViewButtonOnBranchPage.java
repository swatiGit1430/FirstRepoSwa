...
public class TC_05_VerifyTheViewButtonOnBranchPage extends BaseClass{
	
	@Test(dataProvider="ExcelDataProvider")
	 public void TC_BranchView(String strUserName, String strPassword, String strName, String strCode) throws InterruptedException, IOException {
		...
		boolean boolViewBranch = pg_Branch.viewBranch(strName);
		...
		if(boolViewBranch) {
			...
			captureScreen(driver,"TC_BranchView");
