...
public class TC_06_VerifyTheEditFunctionalityInBranchPage extends BaseClass{
	
	@Test(dataProvider="ExcelDataProvider")
	public void TC_EditBranch(String strUserName, String strPassword, String strName, String strCode) throws InterruptedException, IOException {
		...
		boolean boolVerifyEdit = pg_Branch.editBranch(strName, strCode);
		...
		if(boolVerifyEdit) {
			...
			captureScreen(driver,"TC_EditBranch");
